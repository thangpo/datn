...
<div class="container">
    <div class="card">
        ...
        <div>
            ...
            <form action="{{route('themdm')}}" enctype="multipart/form-data" method="POST" style="border: 1px solid;">
                ...
                <div style="display: flex; gap: 20px;">
                    ...
                    <input type="text" value="0" name="xoa_mem" style="display: none;">
                                ...
                                <strong>Tên danh mục</strong><br>
                                    <input style="width: 200px; height: 30px; border-top: none; border-left: none; border-right: none;" type="text" name="ten_sanpham" class="form-control" placeholder="Nhập tên danh mục">
                                </div>
                    </div>
