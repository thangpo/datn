...
<style>
.profile-card {display: flex;background-color: #f0f0f0;width: 650px;margin: auto;}
.left-section {background-color: #333;color: white;padding: 20px;width: 40%;}.right-section {padding: 20px;width: 60%;}
.avatar {background-color: #ddd;border-radius: 50%;width: 100px;height: 100px;margin-bottom: 10px;}
.name {font-size: 1.2em;font-weight: bold;margin-top: 5px;}
.profession {font-size: 1em;margin-top: 5px;margin-bottom: 20px;}
.contact-info {margin-bottom: 20px;}
.projects {margin-bottom: 20px;}
.social-icons {text-align: left;}
.social-icon {display: inline-block;width: 24px;height: 24px;background: #ddd;margin: 0 5px;}
.img2{width: 25px;height: 25px;}
</style>
</head>
<body>
@foreach ($users as $us)
