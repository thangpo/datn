        ...
        <div>
            <div class="row">
                ...
                <div style="text-align: center; border: 1px solid; height: 20px;">
                    <a style="text-decoration: none;" href="{{route('hienthibh', $baihat->nhomnhac_id)}}" class="btn btn-primary float-end">Danh sách nhóm nhạc</a>
                </div>
            </div>
        </div>

            <form action="{{route('baihat.update', $baihat->id)}}" enctype="multipart/form-data" method="POST" style="border: 1px solid;">
                ...
                <div style="display: flex; gap: 20px;">
                    ...
                    <div>
                                <div style="width: 300px; margin-left: 20px; margin-top: 20px;">
                                    ...
                                    <input type="text" name="nhomnhac_id" style="width: 200px; height: 30px; border-top: none; border-left: none; border-right: none;" value="{{$baihat->nhomnhac_id}}">
                                </div>

                                <div style="width: 300px; margin-left: 20px; margin-top: 20px;">
                                <strong>Tên bài hát</strong><br>
                                    <input style="width: 200px; height: 30px; border-top: none; border-left: none; border-right: none;" type="text" name="tenbh" value="{{$baihat->tenbh}}">
                                </div>

                                <div style="width: 300px; margin-left: 20px; margin-top: 20px;">
                                <strong>Ngày phát hành</strong><br>
                                    <input style="width: 200px; height: 30px; border-top: none; border-left: none; border-right: none;" type="date" name="ngayph" value="{{$baihat->ngayph}}">
                                </div>

                                <div style="width: 300px; margin-left: 20px; margin-top: 20px;">
                                <strong>Thể loại</strong><br>
                                    <input type="text" name="theloai" style="width: 200px; height: 30px; border-top: none; border-left: none; border-right: none;" value="{{$baihat->theloai}}">
                                </div>
                    ...
                    <div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                    <img style="width: 300px; height: 200px;" src="{{asset('uploads/'.$baihat->anhbh)}}" id="img" height="500">
                                    </div>
                                ...
                                <strong>Bài hát</strong>
                                    <div style="display: block; width: 100px;">  
                                        <video id="audio-player" width="300" height="200" controls>
                                           <source id="audio-source" src="{{ asset('videos/'.$baihat->nhac) }}">
                                        </video>
