...
<div class="container">
    <div class="card">
        ...
        <div>
            ...
            <form action="{{route('themnhacmoi', $nhomnhac->id)}}" enctype="multipart/form-data" method="POST" style="border: 1px solid;">
                ...
                <div style="display: flex; gap: 20px;">
                    ...
                    <div>
                                ...
                                <strong>Tên bài hát</strong><br>
                                    <input style="width: 200px; height: 30px; border-top: none; border-left: none; border-right: none;" type="text" name="tenn" class="form-control" placeholder="Nhập tên bài hát">
                                </div>

                                <div style="width: 300px; margin-left: 20px; margin-top: 20px;">
                                <strong>Loại nhạc</strong><br>
                                    <input style="width: 200px; height: 30px; border-top: none; border-left: none; border-right: none;" type="text" name="loainhac" placeholder="Tên loại nhạc">
                                </div>

                                <div style="width: 300px; margin-left: 20px; margin-top: 20px;">
                                    <strong>Tác giả</strong><br>
                                    <input type="text" name="tacgia" style="width: 200px; height: 30px; border-top: none; border-left: none; border-right: none;" placeholder="Nhập tên tác giả">
                                </div>
