...
<body>
    ...
    <div class="wrapper">
    <a href="{{ route('listanh', $sanpham->id) }}" style="text-decoration: none;" class="button"><span>Quay lại trang danh sách</span></a>
        <h1>Chọn và hiển thị nhiều ảnh trước khi upload bằng javascript</h1>
       
        <form action="{{route('sualaiasp', $anhsp->id)}}" enctype="multipart/form-data" method="POST">
            @csrf
            @method('PUT')
            ...
            <div>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 20px;">
                    ...
                    <img src="{{asset('uploads/'.$anh_phu)}}" alt="" style="width: 200px; height: 200px;">
