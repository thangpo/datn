...
<body>
    <div style="display: flex; justify-content: center;">
        <div class="modal">
            <form action="{{route('naptien')}}" enctype="multipart/form-data" method="POST" class="form">
            @csrf
                ...
                <div class="credit-card-info--form">
                    <div class="input_container">
                        <label for="password_field" class="input_label">Tên chủ thẻ</label>
                        <input id="password_field" class="input_field" type="text" name="input-name" title="Inpit title" placeholder="Enter your full name">
                    </div>
                    <div class="input_container">
                        <label for="password_field" class="input_label">Mã số thẻ</label>
                        <input id="password_field" class="input_field" type="number" name="input-name" title="Inpit title" placeholder="0000 0000 0000 0000">
                    </div>
                    <div class="input_container">
                        <label for="password_field" class="input_label">Ngày hết hạn</label>
                        <div class="split">
                            <input id="password_field" class="input_field" type="text" name="user_id" title="Expiry Date" value="{{$user->id}}">
                            <input id="password_field" class="input_field" type="number" name="so_tien" title="CVV" placeholder="Số tiền cần nạp">
                        </div>
                    </div>
                </div>
                <button class="purchase--btn">Nạp ngay</button>
            </form>
        </div>
    </div>
</body>
