...
<div class="container">
    <div style="display: flex; justify-content: center; align-items: center; margin-top: 20px; gap: 20px;">
        ...
        <div class="card-body">
            <form action="{{route('suavip', $uservip->id)}}" enctype="multipart/form-data" method="POST" style="border: 1px solid; width: 450px; height: 450px;">
                ...
                <div style="display: flex; gap: 20px;">
                    ...
                    <div>
                        <div class="form-group" style="width: 300px; margin-left: 20px; margin-top: 20px;">
                            ...
                            <input style="width: 200px; height: 30px; border-top: none; border-left: none; border-right: none;" type="text" name="ten_vip" class="form-control" value="{{$uservip->ten_vip}}">
                        </div>
                        <div class="form-group" style="width: 300px; margin-left: 20px; margin-top: 20px;">
                            <strong>Giá bán VIP</strong><br>
                            <input style="width: 200px; height: 30px; border-top: none; border-left: none; border-right: none;" type="text" name="gia" class="form-control" value="{{$uservip->gia}}">
                        </div>
                    </div>
                    ...
                    <div>
                        <div class="form-group" style="width: 300px; margin-top: 20px;">
                            ...
                            <select name="ngay_hh" id="">
                                <option {{$uservip->ngay_hh == 30 ? 'selected' : null}} value="30">30 ngày</option>
                                <option {{$uservip->ngay_hh == 90 ? 'selected' : null}} value="90">90 ngày</option>
                                <option {{$uservip->ngay_hh == 160 ? 'selected' : null}} value="160">160 ngày</option>
                            </select>
                        </div>
                        <div class="form-group" style="width: 300px; margin-left: 20px; margin-top: 20px;">
                            <strong>Đặt quyền của VIP</strong><br>
                            <input style="width: 200px; height: 30px; border-top: none; border-left: none; border-right: none;" type="text" name="dac_quyen" class="form-control" value="{{$uservip->dac_quyen}}">
                        </div>
                    </div>

                </div>

                <button type="submit" style="margin-top: 20px; width: 100%; height: 30px;">Sửa Vip</button>
            </form>
        </div>
