...
<div class="container">
    <div style="display: flex; justify-content: center; align-items: center; margin-top: 20px; gap: 20px;">
        ...
        <div class="card-body">
            <form action="{{route('banner.store')}}" enctype="multipart/form-data" method="POST" style="border: 1px solid; width: 450px; height: 450px;">
            <h1 style="text-align: center;">Thêm mới banner trang chủ</h1>
                @csrf
                ...
                <button type="submit" style="margin-top: 20px; width: 100%; height: 30px;">Thêm Banner</button>
            </form>
        </div>
