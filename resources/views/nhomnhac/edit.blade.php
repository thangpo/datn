...
<div class="container">
    <div class="card">
        ...
        <div>
            ...
            <form action="{{route('nhomnhac.update', $nhomnhac->id)}}" enctype="multipart/form-data" method="POST" style="border: 1px solid;">
                ...
                <div style="display: flex; gap: 20px;">
                    ...
                    <input type="text" value="0" name="xoa_mem" style="display: none;">
                                ...
                                <strong>Tên nhóm nhạc</strong><br>
                                    <input style="width: 200px; height: 30px; border-top: none; border-left: none; border-right: none;" type="text" name="tennn" value="{{$nhomnhac->tennn}}">
                                </div>

                                <div class="form-group" style="width: 300px; margin-left: 20px; margin-top: 20px;">
                                <strong>Ngày thành lập</strong><br>
                                    <input style="width: 200px; height: 30px; border-top: none; border-left: none; border-right: none;" type="date" name="ngaytl" value="{{$nhomnhac->ngaytl}}">
                                </div>
                    ...
                    <div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <img style="width: 300px; height: 200px;" src="{{asset('uploads/'.$nhomnhac->logonn)}}" id="img" height="500">
                                    </div>
